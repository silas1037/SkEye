...
public class KalmanFilter {
    ...
    public void correct(RealVector z) throws NullArgumentException, DimensionMismatchException, SingularMatrixException {
        ...
        this.errorCovariance = MatrixUtils.createRealIdentityMatrix(kalmanGain.getRowDimension()).subtract(kalmanGain.multiply(this.measurementMatrix)).multiply(this.errorCovariance);
    }
}
