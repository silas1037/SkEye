...
public class TestUtils {
    ...
    /* renamed from: t */
    public static double m22t(double mu, double[] observed) throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.mo3940t(mu, observed);
    }

    /* renamed from: t */
    public static double m21t(double mu, StatisticalSummary sampleStats) throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.mo3939t(mu, sampleStats);
    }

    /* renamed from: t */
    public static double m24t(double[] sample1, double[] sample2) throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.mo3942t(sample1, sample2);
    }

    /* renamed from: t */
    public static double m23t(StatisticalSummary sampleStats1, StatisticalSummary sampleStats2) throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.mo3941t(sampleStats1, sampleStats2);
    }
    ...
    /* renamed from: g */
    public static double m20g(double[] expected, long[] observed) throws NotPositiveException, NotStrictlyPositiveException, DimensionMismatchException {
        return G_TEST.mo3895g(expected, observed);
    }
