...
public class DfpMath {
    ...
    public static Dfp log(Dfp a) {
        ...
        if (a.equals(a.getZero()) || a.lessThan(a.getZero()) || a.isNaN()) {
            ...
            Dfp x = new Dfp(a);
            int lr = x.log10K();
            Dfp x2 = x.divide(pow(a.newInstance(Dfp.RADIX), lr));
            ...
            spx[0] = a.newInstance(new StringBuilder().append((lr * 4) + p2).toString());
            spx[1] = a.getZero();
            Dfp[] spy2 = splitMult(a.getField().getLn2Split(), spx);
            spz[0] = spz[0].add(spy2[0]);
            spz[1] = spz[1].add(spy2[1]);
            spx[0] = a.newInstance(new StringBuilder().append(lr * 4).toString());
            spx[1] = a.getZero();
                    ...
                    if (x.equals(one) && y.classify() == 1) {
                        ...
                        if (!y.lessThan(x.newInstance(100000000)) || !y.greaterThan(x.newInstance(-100000000))) {
                            ...
                            if (v.unequal(zero)) {
                                ...
                                r = splitPow(split(x), ui).multiply(pow(two, b.intValue())).multiply(exp(a.subtract(b.multiply(x.getField().getLn2()))));
                            } else {
