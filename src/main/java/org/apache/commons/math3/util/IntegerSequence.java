...
public class IntegerSequence {
    ...
    public static class Range implements Iterable<Integer> {
        ...
        public Iterator<Integer> iterator() {
            return Incrementor.create().withStart(this.start).withMaximalCount((this.step > 0 ? 1 : -1) + this.max).withIncrement(this.step);
        }
    }
    ...
    public static class Incrementor implements Iterator<Integer> {
        private static final MaxCountExceededCallback CALLBACK = new MaxCountExceededCallback() {
            /* class org.apache.commons.math3.util.IntegerSequence.Incrementor.C03521 */
